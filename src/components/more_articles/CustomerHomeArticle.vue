...
<div class="ms-list">
    <el-row class="operation">
      ...
      <el-button-group>
        <el-button v-show="showList" type="primary" size="small" @click="addRow()">发布</el-button>
      </el-button-group>
    </el-row>
  <ms-slide
    :title="row.edit.enabled ? '编辑' : '发布'"
    :width="800"
    @close="closeSlide()"
    ref="slideModifyRow">
  ...
  <div v-show="showList">
    ...
    <el-table
      ...
      <el-table-column prop="title" label="标题" min-width="160" fixed>
      ...
      <el-table-column prop="updatorTime" label="更新时间" min-width="140"></el-table-column>
...
<script>
  ...
  import Api from '@/api/platform/customer-home-article'
  import ResponseParse from '@/utils/response-parse'
  import MsSlide from '@/components/common/Slide.vue'
  import MsDetailShow from '@/components/common/DetailShow'
  import MsSearch from '@/components/common/Search.vue'
  import {SEARCH_CONDITION, FormArgument} from '@/models/platform/customer-home-article'
