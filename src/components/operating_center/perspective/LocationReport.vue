  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>头条位置数据列表</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    <ms-slide
      ...
      <el-form class="form" label-width="120px" size="small" :model="log" style="margin-top: 35px">
        ...
        <el-form-item label="报告类型" prop="reportGenre">
          ...
          <span v-else-if="log.reportGenre === 9">平台报告</span>
          <span v-else-if="log.reportGenre === 10">网络报告</span>
          <span v-else-if="log.reportGenre === 11">学历报告</span>
          <span v-else-if="log.reportGenre === 12">头条位置报告</span>
        </el-form-item>
    ...
    <el-table
      ...
      <el-table-column prop="channel" label="推广渠道" min-width="80"></el-table-column>
      ...
      <el-table-column prop="planTitle" label="广告计划" min-width="250"></el-table-column>
      <el-table-column prop="group" label="广告组" min-width="100"></el-table-column>
      <el-table-column prop="location" label="投放位置" min-width="80"></el-table-column>
      ...
      <el-table-column prop="translationCost" label="转化成本" min-width="80" align="right" header-align="center">
        <template slot-scope="scope">
          {{scope.row.translationCost.toFixed(2)}}
        </template>
      </el-table-column>
...
<script>
  ...
  import { SEARCH_CONDITION } from '@/models/report/location-report'
