  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>意图词数据列表</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    <ms-slide
      ...
      <el-form class="form" label-width="120px" size="small" :model="log" style="margin-top: 35px">
        ...
        <el-form-item label="报告类型" prop="reportGenre">
          ...
          <span v-else-if="log.reportGenre === 14">意图词报告</span>
        </el-form-item>
    ...
    <el-table
      ...
      <el-table-column prop="channel" label="推广渠道" min-width="80">
        <template slot-scope="scope">
      ...
      <el-table-column prop="unitTitle" label="推广单元" min-width="100"></el-table-column>
      <el-table-column prop="intentionWord" label="意图词" min-width="80">
        <template slot-scope="scope">
          <a href="javascript:;" @click="searchCriteria(scope.row.intentionWord, index=4)">{{scope.row.intentionWord}}</a>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="impressionCostCoin" label="展现消费" min-width="80" align="right" header-align="center" v-if='show'>
        <template slot-scope="scope">
          <span>{{scope.row.impressionCostCoin.toFixed(2)}}%</span>
        </template>
      </el-table-column>
