  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>时段数据列表</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    <el-table
      ...
      <el-table-column prop="hour" label="小时" min-width="60" fixed></el-table-column>
...
<script>
  ...
  import Api from '@/api/report/time-share-report'
  import LogApi from '@/api/report/perspective-report-import-log'
  import ResponseParse from '@/utils/response-parse'
  import { SEARCH_CONDITION } from '@/models/report/time-share-report'
...
//            this.tbHeight = ''
            this.table.list = []
            this.$message.error(response.data.error || '时段数据获取失败')
          }
