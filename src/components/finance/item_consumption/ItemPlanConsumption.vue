  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>项目计划日报表</el-breadcrumb-item>
    ...
    <el-table
      ...
      <el-table-column prop="planTitle" label="推广计划" min-width="240">
        <template slot-scope="scope">
          <a href="javascript:;" @click="searchCriteria(scope.row.planTitle, index=4)">{{scope.row.planTitle}}</a>
        </template>
      </el-table-column>
...
<script>
  ...
  import { SEARCH_CONDITION } from '@/models/report/item-plan-daily-consumption'
...
//      },
      requestList () {
        ...
        Api.listPlanConsumption({search: search}, response => {
