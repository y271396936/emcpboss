  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>客服部</el-breadcrumb-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      requestList () {
        this.table.loading = true
        const search = Object.assign({departmentId: 6, type: 1}, this.table.pagination, this.search.condition)
