  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>财务部</el-breadcrumb-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      requestList () {
        this.table.loading = true
        const search = Object.assign({departmentId: 2, type: 1}, this.table.pagination, this.search.condition)
