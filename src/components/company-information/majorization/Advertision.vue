  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>宣传资料</el-breadcrumb-item>
      </el-breadcrumb>
      <el-button-group>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      requestList () {
        this.table.loading = true
        const search = Object.assign({departmentId: 18, type: 3}, this.table.pagination, this.search.condition)
