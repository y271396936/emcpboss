  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>优化部</el-breadcrumb-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      requestList () {
        this.table.loading = true
        const search = Object.assign({departmentId: 18, type: 2}, this.table.pagination, this.search.condition)
        ...
        this.$refs['formModifyRow'].validate((valid) => {
          if (valid) {
            if (this.row.edit.enabled) {
              ...
              this.row.form.departmentId = 18
              this.row.form.type = 2
