<template>
  <div class="search">
    ...
    <el-row class="search-list">
      <div v-show="search.visible" v-for="search in data" :key="search.name" class="search-item" v-if="search.type != conditionType.SELECT_RADIO && search.type != 'MARKDATA'">
      ...
      <div class="pickRadio" v-show="search.visible" v-for="search in data" v-if="search.type === 'MARKDATA'">
        <span class="pick-title">{{search.title}}：</span>
        <el-radio-group v-model="search.value" size="small">
      ...
      selectiveConditions () {
        ...
        this.data.forEach(function (item, idx) {
          if (item.value !== undefined && item.value !== null && item.value !== '') {
            ...
            if (item.type !== 'MARKDATA' || typeof item.value !== 'string') {
