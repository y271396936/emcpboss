  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>词性日报</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    <el-table
      ...
      :show-summary=true
      :fit="true">
      <el-table-column prop="keywordNatureTitle" label="词性" min-width="100" fixed/>
      <el-table-column v-for="n in 31" :key="n" :prop="n.toString()" :label="n+'日'" min-width="80" align="right" header-align="center"/>
      <el-table-column prop="total" label="合计" min-width="120" align="right" header-align="center"/>
    </el-table>
    <el-pagination
      class="pagination"
...
//              this.tbHeight = ''
//            } else {
//              if (this.table.pagination.totalPage === this.table.pagination.page && Object.keys(this.table.list.data).length < 15) {
//                this.tbHeight = ''
//              } else {
