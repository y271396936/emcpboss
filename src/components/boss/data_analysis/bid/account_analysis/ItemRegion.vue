<template>
  <div class="ms-list">
    <el-row class="operation">
      ...
      <el-button-group>
        <el-button type="primary" size="small" @click="skip('/data/bid/item-province')">项目省份分析</el-button>
        <el-tooltip effect="dark" placement="right-start">
          <div slot="content">
            历史数据为：不包括当前月，从上月开始，三个月之前的所有有记录的数据<br/>
            数据量很大，查询速度不快
          </div>
          <el-button type="primary" size="small" @click="skip('/data/bid/backup-item-region')">查看历史数据</el-button>
        </el-tooltip>
      </el-button-group>
    </el-row>
