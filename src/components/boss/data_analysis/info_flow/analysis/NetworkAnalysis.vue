<template>
  <div class="ms-list">
    ...
    <el-table
      ...
      <el-table-column prop="network" label="网络" min-width="60" align="right"
...
<script>
  ...
  import Api from '@/api/report/information-net-report'
  import ResponseParse from '@/utils/response-parse'
  import { SEARCH_CONDITION } from '@/models/report/information-net-report'
  import moment from 'moment'
