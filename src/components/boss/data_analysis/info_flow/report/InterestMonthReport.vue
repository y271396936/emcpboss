  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>信息流月报</el-breadcrumb-item>
        <el-breadcrumb-item>兴趣月报</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    <el-table
      ...
      <el-table-column prop="industry" label="行业" min-width="150"
                       v-if="search.condition.dataGroup !== 1">
        <template slot-scope="scope">
...
<script>
  ...
  import { MONTH_REPORT_SEARCH_CONDITION } from '@/models/report/interest-type-report'
