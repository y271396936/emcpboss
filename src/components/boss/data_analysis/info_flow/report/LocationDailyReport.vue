  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>头条位置日报</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
...
<script>
  ...
  import { DAILY_REPORT_SEARCH_CONDITION } from '@/models/report/location-report'
  ...
  export default {
    ...
    created () {
      this.search.list = DAILY_REPORT_SEARCH_CONDITION
      let date = []
    ...
    methods: {
      ...
      requestList () {
        ...
        Api.listDailyReport({search: search}, response => {
