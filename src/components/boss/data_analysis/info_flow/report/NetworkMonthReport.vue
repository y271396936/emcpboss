  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>网络月报</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
...
<script>
  ...
  import { MONTH_REPORT_SEARCH_CONDITION } from '@/models/report/network-report'
  ...
  export default {
    ...
    methods: {
      ...
      requestList () {
        ...
        Api.getMonthReport({search: search}, response => {
