  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>性别月报</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    <el-table
      ...
      <el-table-column prop="channel" label="渠道" min-width="140" v-if="search.condition.dataGroup !== 2">
        <template slot-scope="scope">
...
<script>
  ...
  import { MONTH_SEARCH_CONDITION } from '@/models/report/gender-report'
