  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>年龄月报</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
...
<script>
  ...
  import { MONTH_REPORT_SEARCH_CONDITION } from '@/models/report/age-range-report'
  ...
  export default {
    ...
    methods: {
      ...
      requestList () {
        ...
        Api.ageMonthlist({search: search}, response => {
