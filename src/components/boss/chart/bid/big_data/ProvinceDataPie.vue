  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>省份月占比图</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    <div>
      <div v-for="(value, key) in recombineData" v-if="show[type[key]]" class="chart"
        ...
        <ve-ring v-if="key === 'impression' || key === 'costCoin' || key === 'click' || key === 'translation'"
                 :data="value" :extend="extend1" :title="value.title" :settings="chartSetting"
                 :loading="chartLoading" :data-empty="value.empty" :legend-visible="false"></ve-ring>
...
<script>
  ...
  import { MONTH_PIE_SEARCH_CONDITION } from '@/models/report/province-consumption'
  ...
  export default {
    ...
    created () {
      this.search.list = MONTH_PIE_SEARCH_CONDITION
