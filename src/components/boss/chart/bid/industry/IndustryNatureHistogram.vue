  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>词性柱状图</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
...
<script>
  ...
  import { HISTOGRAM_SEARCH_CONDITION } from '@/models/report/industry-nature-consumption'
    ...
    computed: {
      recombineList () {
        if (Object.keys(this.titleData).length > 0) {
          ...
          this.title.text = this.search.condition.year + '年-' + this.titleData['titleIndustry'] + '-' + this.titleData['titleKeyword']
        } else {
          this.dataEmpty = true
          this.title.text = ''
        }
