  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>行业月占比图</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
    ...
    <div>
      <div
        v-for="(value, key) in recombineData" :key="key" v-if="show[type[key]]"
        class="chart"
...
<script>
  ...
  import { PIE_SEARCH_CONDITION } from '@/models/report/industry-consumption'
