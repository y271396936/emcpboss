  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>城市占比图</el-breadcrumb-item>
      </el-breadcrumb>
    </el-row>
...
<script>
  ...
  import { CITY_PIE_SEARCH_CONDITION } from '@/models/report/item-region-consumption'
  ...
  export default {
    ...
    created () {
      this.search.list = CITY_PIE_SEARCH_CONDITION
    ...
    methods: {
      requestList () {
        ...
        Api.getCityPie({search: search}, response => {
