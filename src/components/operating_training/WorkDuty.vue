  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>内部资料</el-breadcrumb-item>
...
<script>
  ...
  import Api from '@/api/platform/train-work-duty'
  import ResponseParse from '@/utils/response-parse'
  import { FormArgument, SEARCH_CONDITION } from '@/models/platform/train-work-duty'
