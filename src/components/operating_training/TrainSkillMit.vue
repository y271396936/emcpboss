  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>内部技巧</el-breadcrumb-item>
      </el-breadcrumb>
      <el-button-group>
        <el-button v-show="showList" type="primary" size="small" @click="addRow()">新增技巧</el-button>
      </el-button-group>
    </el-row>


    <ms-slide
      :title="row.edit.enabled ? '编辑技巧' : '新增技巧'"
      :width="800"
      @close="closeSlide()"
      ref="slideModifyRow">
    ...
    <div class="detail" v-show="!showList">
      <div class="back" @click="backDetail()"><icon name="angle-left" scale="2" class="icon-bg"></icon></div>
...
<script>
  ...
  import Api from '@/api/platform/train-skill'
  import ResponseParse from '@/utils/response-parse'
  import MsSlide from '@/components/common/Slide.vue'
  import MsSearch from '@/components/common/Search.vue'
  import {SEARCH_CONDITION, FormArgument} from '@/models/platform/train-skill'
