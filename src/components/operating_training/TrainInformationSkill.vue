  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>技巧操作</el-breadcrumb-item>
      </el-breadcrumb>
      <el-button-group>
...
<script>
  ...
  import Api from '@/api/platform/train-information-skill'
  import ResponseParse from '@/utils/response-parse'
  import MsSlide from '@/components/common/Slide.vue'
  import MsDetailShow from '@/components/common/DetailShow'
  import MsSearch from '@/components/common/Search.vue'
  import {SEARCH_CONDITION, FormArgument} from '@/models/platform/train-information-skill'
