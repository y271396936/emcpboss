  ...
  <div class="ms-list">
    ...
    <div v-show="showList">
      ...
      <el-table
        ...
        <el-table-column prop="developer" label="发布人" min-width="80">
        </el-table-column>
        <el-table-column prop="createTime" label="发布时间" min-width="80"></el-table-column>
      ...
      <div class="detail-scroll" ref="detail">
        <div class="text" :style="{marginTop: 0}">
          ...
          <div class="time-author">
            <div class="time">{{ formatTime(detail.createTime) }}</div>
            作者:
            <div class="author">{{ detail.developer}}</div>
          </div>
...
<script>
  ...
  import Api from '@/api/platform/train-bid-skill'
  import ResponseParse from '@/utils/response-parse'
  import { FormArgument, SEARCH_CONDITION } from '@/models/platform/train-bid-skill'
  import FormTokenApi from '@/api/system/form-token'
  import MsConfirmButton from '../common/ConfirmButton'
  ...
  export default {
    ...
    methods: {
      seeDetail (index) {
        ...
        this.detail.createTime = this.table.list[index].createTime
        this.detail.developer = this.table.list[index].developer
        this.showList = false
      },
      backDetail () {
        this.showList = true
