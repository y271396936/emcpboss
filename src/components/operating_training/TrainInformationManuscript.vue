<template>
  <div class="ms-list">
    <el-row class="operation">
      ...
      <el-button-group>
        <el-button v-show="showList" type="primary" size="small" @click="addRow()">新增上稿流程</el-button>
      </el-button-group>
    </el-row>

    <ms-slide
      :title="row.edit.enabled ? '编辑上稿流程' : '新增上稿流程'"
      :width="800"
      @close="closeSlide()"
      ref="slideModifyRow">
...
<script>
  ...
  import Api from '@/api/platform/train-information-manuscript'
  import ResponseParse from '@/utils/response-parse'
  import MsSlide from '@/components/common/Slide.vue'
  import MsDetailShow from '@/components/common/DetailShow'
  import MsSearch from '@/components/common/Search.vue'
  import {SEARCH_CONDITION, FormArgument} from '@/models/platform/train-information-manuscript'
