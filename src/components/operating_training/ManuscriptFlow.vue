  ...
  <div class="ms-list">
    <el-row class="operation">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>上稿流程</el-breadcrumb-item>
...
<script>
  ...
  import Api from '@/api/platform/manuscript-flow'
  import ResponseParse from '@/utils/response-parse'
  import { FormArgument, SEARCH_CONDITION } from '@/models/platform/manuscript-flow'
